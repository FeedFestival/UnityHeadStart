...
namespace GameScrypt.Example
{
    public class DeviceJsonData : GSJsonData
    {
        ...
        public void UpdatePlayer(PlayerSettings devicePlayer)
        {
            var playerJsonObj = base.GetJsonObj<DeviceJson>();
            playerJsonObj.playerSettings = devicePlayer;
            GSJsonService.WriteJsonToFile(base._path, playerJsonObj);
        }
    ...
    public class DeviceJson
    {
        ...
        public DeviceJson(PlayerSettings _devicePlayer, GameSettings _gameSettings)
        {
            playerSettings = _devicePlayer;
